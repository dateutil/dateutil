...
class _ttinfo:
    def __eq__(self, other: _ttinfo) -> bool: ...
...
class tzfile:
    def __eq__(self, other: tzfile) -> bool: ...
    def __init__(
        self,
...
class tzlocal:
    def __eq__(self, other: Union[tzlocal, tzoffset, tzutc]) -> bool: ...
    def __init__(self) -> None: ...
...
class tzoffset:
    def __eq__(self, other: tzoffset) -> bool: ...
    def __init__(self, name: Optional[str], offset: Union[int, float, timedelta]) -> None: ...
    def __ne__(self, other: Union[int, ComparesEqualClass]) -> bool: ...
    def __repr__(self) -> str: ...
    def dst(self, dt: datetime) -> timedelta: ...
    def fromutc(self, dt: datetime) -> datetime: ...
    def is_ambiguous(self, dt: datetime) -> bool: ...
...
class tzrange:
    def __eq__(self, other: tzrange) -> bool: ...
    def __init__(
        self,
...
class tzutc:
    def __eq__(self, other: Union[tzutc, tzoffset]) -> bool: ...
    def __ne__(self, other: Union[int, tzoffset]) -> bool: ...
    def __repr__(self) -> str: ...
    def dst(self, dt: datetime) -> timedelta: ...
    def fromutc(self, dt: datetime) -> datetime: ...
    def is_ambiguous(self, dt: datetime) -> bool: ...
