...
class RRuleTest(WarningTestMixin, unittest.TestCase):
    ...
    def testYearlyInterval(self):
        self.assertEqual(
            list(
                rrule(YEARLY, count=3, interval=2, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1997, 9, 2, 9, 0),
                datetime(1999, 9, 2, 9, 0),
    ...
    def testYearlyIntervalLarge(self):
        self.assertEqual(
            list(
                rrule(YEARLY, count=3, interval=100, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1997, 9, 2, 9, 0),
    ...
    def testYearlyByMonth(self):
        self.assertEqual(
            list(
                rrule(
                    YEARLY, count=3, bymonth=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
    ...
    def testYearlyByWeekNo(self):
        self.assertEqual(
            list(
                rrule(YEARLY, count=3, byweekno=20, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
    ...
    def testYearlyByEaster(self):
        self.assertEqual(
            list(
                rrule(YEARLY, count=3, byeaster=0, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
    ...
    def testYearlyByEasterPos(self):
        self.assertEqual(
            list(
                rrule(YEARLY, count=3, byeaster=1, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
    ...
    def testYearlyByHour(self):
        self.assertEqual(
            list(
                rrule(
                    YEARLY, count=3, byhour=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
    ...
    def testMonthlyInterval(self):
        self.assertEqual(
            list(
                rrule(MONTHLY, count=3, interval=2, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1997, 9, 2, 9, 0),
                datetime(1997, 11, 2, 9, 0),
    ...
    def testMonthlyIntervalLarge(self):
        self.assertEqual(
            list(
                rrule(MONTHLY, count=3, interval=18, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1997, 9, 2, 9, 0),
    ...
    def testMonthlyByMonth(self):
        self.assertEqual(
            list(
                rrule(
                    MONTHLY, count=3, bymonth=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
                datetime(1998, 1, 2, 9, 0),
    ...
    def testMonthlyByWeekNo(self):
        self.assertEqual(
            list(
                rrule(MONTHLY, count=3, byweekno=20, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1998, 5, 11, 9, 0),
                datetime(1998, 5, 12, 9, 0),
    ...
    def testMonthlyByEaster(self):
        self.assertEqual(
            list(
                rrule(MONTHLY, count=3, byeaster=0, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1998, 4, 12, 9, 0),
                datetime(1999, 4, 4, 9, 0),
    ...
    def testMonthlyByEasterPos(self):
        self.assertEqual(
            list(
                rrule(MONTHLY, count=3, byeaster=1, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1998, 4, 13, 9, 0),
                datetime(1999, 4, 5, 9, 0),
    ...
    def testMonthlyByHour(self):
        self.assertEqual(
            list(
                rrule(
                    MONTHLY, count=3, byhour=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
                datetime(1997, 9, 2, 18, 0),
    ...
    def testWeeklyInterval(self):
        self.assertEqual(
            list(
                rrule(WEEKLY, count=3, interval=2, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1997, 9, 2, 9, 0),
                datetime(1997, 9, 16, 9, 0),
    ...
    def testWeeklyIntervalLarge(self):
        self.assertEqual(
            list(
                rrule(WEEKLY, count=3, interval=20, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1997, 9, 2, 9, 0),
                datetime(1998, 1, 20, 9, 0),
    ...
    def testWeeklyByMonth(self):
        self.assertEqual(
            list(
                rrule(
                    WEEKLY, count=3, bymonth=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
                datetime(1998, 1, 6, 9, 0),
    ...
    def testWeeklyByWeekNo(self):
        self.assertEqual(
            list(
                rrule(WEEKLY, count=3, byweekno=20, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1998, 5, 11, 9, 0),
                datetime(1998, 5, 12, 9, 0),
    ...
    def testWeeklyByEaster(self):
        self.assertEqual(
            list(
                rrule(WEEKLY, count=3, byeaster=0, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1998, 4, 12, 9, 0),
                datetime(1999, 4, 4, 9, 0),
    ...
    def testWeeklyByEasterPos(self):
        self.assertEqual(
            list(
                rrule(WEEKLY, count=3, byeaster=1, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1998, 4, 13, 9, 0),
                datetime(1999, 4, 5, 9, 0),
    ...
    def testWeeklyByHour(self):
        self.assertEqual(
            list(
                rrule(
                    WEEKLY, count=3, byhour=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
                datetime(1997, 9, 2, 18, 0),
    ...
    def testDailyIntervalLarge(self):
        self.assertEqual(
            list(
                rrule(DAILY, count=3, interval=92, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1997, 9, 2, 9, 0),
    ...
    def testDailyByMonth(self):
        self.assertEqual(
            list(
                rrule(
                    DAILY, count=3, bymonth=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
                datetime(1998, 1, 1, 9, 0),
    ...
    def testDailyByWeekNo(self):
        self.assertEqual(
            list(
                rrule(DAILY, count=3, byweekno=20, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1998, 5, 11, 9, 0),
                datetime(1998, 5, 12, 9, 0),
    ...
    def testDailyByEasterNeg(self):
        self.assertEqual(
            list(
                rrule(DAILY, count=3, byeaster=-1, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1998, 4, 11, 9, 0),
                datetime(1999, 4, 3, 9, 0),
    ...
    def testDailyByHour(self):
        self.assertEqual(
            list(
                rrule(
                    DAILY, count=3, byhour=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
                datetime(1997, 9, 2, 18, 0),
    ...
    def testDailyByMinute(self):
        self.assertEqual(
            list(
                rrule(
                    DAILY, count=3, byminute=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
                datetime(1997, 9, 2, 9, 6),
    ...
    def testDailyBySecond(self):
        self.assertEqual(
            list(
                rrule(
                    DAILY, count=3, bysecond=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
                datetime(1997, 9, 2, 9, 0, 6),
    ...
    def testHourlyInterval(self):
        self.assertEqual(
            list(
                rrule(HOURLY, count=3, interval=2, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1997, 9, 2, 9, 0),
                datetime(1997, 9, 2, 11, 0),
    ...
    def testHourlyIntervalLarge(self):
        self.assertEqual(
            list(
                rrule(HOURLY, count=3, interval=769, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1997, 9, 2, 9, 0),
    ...
    def testHourlyByMonth(self):
        self.assertEqual(
            list(
                rrule(
                    HOURLY, count=3, bymonth=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
    ...
    def testHourlyByWeekNo(self):
        self.assertEqual(
            list(
                rrule(HOURLY, count=3, byweekno=20, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
    ...
    def testHourlyByEaster(self):
        self.assertEqual(
            list(
                rrule(HOURLY, count=3, byeaster=0, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
    ...
    def testHourlyByEasterPos(self):
        self.assertEqual(
            list(
                rrule(HOURLY, count=3, byeaster=1, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
    ...
    def testHourlyByHour(self):
        self.assertEqual(
            list(
                rrule(
                    HOURLY, count=3, byhour=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
                datetime(1997, 9, 2, 18, 0),
    ...
    def testMinutelyInterval(self):
        self.assertEqual(
            list(
                rrule(MINUTELY, count=3, interval=2, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1997, 9, 2, 9, 0),
                datetime(1997, 9, 2, 9, 2),
    ...
    def testMinutelyIntervalLarge(self):
        self.assertEqual(
            list(
                rrule(
                    MINUTELY, count=3, interval=1501, dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
                datetime(1997, 9, 2, 9, 0),
    ...
    def testMinutelyByWeekNo(self):
        self.assertEqual(
            list(
                rrule(
                    MINUTELY, count=3, byweekno=20, dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
                datetime(1998, 5, 11, 0, 0),
    ...
    def testMinutelyByEaster(self):
        self.assertEqual(
            list(
                rrule(MINUTELY, count=3, byeaster=0, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1998, 4, 12, 0, 0),
    ...
    def testMinutelyByEasterPos(self):
        self.assertEqual(
            list(
                rrule(MINUTELY, count=3, byeaster=1, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1998, 4, 13, 0, 0),
    ...
    def testMinutelyByEasterNeg(self):
        self.assertEqual(
            list(
                rrule(
                    MINUTELY, count=3, byeaster=-1, dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
                datetime(1998, 4, 11, 0, 0),
    ...
    def testSecondlyInterval(self):
        self.assertEqual(
            list(
                rrule(SECONDLY, count=3, interval=2, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
                datetime(1997, 9, 2, 9, 0, 0),
                datetime(1997, 9, 2, 9, 0, 2),
    ...
    def testSecondlyByWeekNo(self):
        self.assertEqual(
            list(
                rrule(
                    SECONDLY, count=3, byweekno=20, dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
    ...
    def testSecondlyByEaster(self):
        self.assertEqual(
            list(
                rrule(SECONDLY, count=3, byeaster=0, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
    ...
    def testSecondlyByEasterPos(self):
        self.assertEqual(
            list(
                rrule(SECONDLY, count=3, byeaster=1, dtstart=datetime(1997, 9, 2, 9, 0))
            ),
            [
    ...
    def testSecondlyByEasterNeg(self):
        self.assertEqual(
            list(
                rrule(
                    SECONDLY, count=3, byeaster=-1, dtstart=datetime(1997, 9, 2, 9, 0)
                )
            ),
            [
    ...
    def testLongIntegers(self):
        if not PY3:  # There is no longs in python3
            self.assertEqual(
                ...
                [datetime(1998, 2, 5, 6, 6, 6), datetime(1998, 2, 12, 6, 6, 6)],
            )
            self.assertEqual(
                list(
                    rrule(
                ...
                [datetime(1998, 1, 5, 9, 0), datetime(2004, 1, 5, 9, 0)],
            )
    ...
    def testHourlyBadRRule(self):
        ...
        self.assertRaises(
            ...
            HOURLY,
            **dict(
                interval=4, byhour=(7, 11, 15, 19), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testUntilWithDate(self):
        self.assertEqual(
            list(
                rrule(DAILY, dtstart=datetime(1997, 9, 2, 9, 0), until=date(1997, 9, 5))
            ),
            [
                datetime(1997, 9, 2, 9, 0),
                datetime(1997, 9, 3, 9, 0),
    ...
    def testGetItem(self):
        self.assertEqual(
            rrule(DAILY, count=3, dtstart=datetime(1997, 9, 2, 9, 0))[0],
            datetime(1997, 9, 2, 9, 0),
        )

    def testGetItemNeg(self):
        self.assertEqual(
            rrule(DAILY, count=3, dtstart=datetime(1997, 9, 2, 9, 0))[-1],
            datetime(1997, 9, 4, 9, 0),
        )
    ...
    def testCount(self):
        self.assertEqual(
            rrule(DAILY, count=3, dtstart=datetime(1997, 9, 2, 9, 0)).count(), 3
        )

    def testCountZero(self):
        self.assertEqual(
            rrule(YEARLY, count=0, dtstart=datetime(1997, 9, 2, 9, 0)).count(), 0
        )
    ...
    def testBefore(self):
        self.assertEqual(
            rrule(DAILY, dtstart=datetime(1997, 9, 2, 9, 0)).before(  # count=5
    ...
    def testXAfter(self):
        self.assertEqual(
            list(
                rrule(DAILY, dtstart=datetime(1997, 9, 2, 9, 0)).xafter(
                    datetime(1997, 9, 8, 9, 0), count=12
                )
            ),
            [
                datetime(1997, 9, 9, 9, 0),
    ...
    def testXAfterInc(self):
        self.assertEqual(
            list(
                rrule(DAILY, dtstart=datetime(1997, 9, 2, 9, 0)).xafter(
                    datetime(1997, 9, 8, 9, 0), count=12, inc=True
                )
            ),
            [
    ...
    def testStrWithTZIDCallable(self):
        ...
        exp = [
            datetime(1997, 9, 2, 9, 0, tzinfo=TZ),
    ...
    def testStrValueDatetime(self):
        ...
        self.assertEqual(
            list(rr), [datetime(1997, 9, 2, 9, 0, 0), datetime(1998, 9, 2, 9, 0, 0)]
        )
    ...
    def testStrValueDate(self):
        ...
        self.assertEqual(
            list(rr), [datetime(1997, 9, 2, 0, 0, 0), datetime(1998, 9, 2, 0, 0, 0)]
        )
    ...
    def testStrUntilWithTZ(self):
        ...
        self.assertEqual(
            list(rr),
            [
                datetime(1997, 1, 1, 0, 0, 0, tzinfo=NYC),
    ...
    def testToStrYearlyByMonth(self):
        self._rrulestr_reverse_test(
            rrule(YEARLY, count=3, bymonth=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrYearlyByMonthDay(self):
        self._rrulestr_reverse_test(
            rrule(
                YEARLY, count=3, bymonthday=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrYearlyByWeekDay(self):
        self._rrulestr_reverse_test(
            rrule(
                YEARLY, count=3, byweekday=(TU, TH), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrYearlyByHour(self):
        self._rrulestr_reverse_test(
            rrule(YEARLY, count=3, byhour=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrYearlyByMinute(self):
        self._rrulestr_reverse_test(
            rrule(YEARLY, count=3, byminute=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrYearlyBySecond(self):
        self._rrulestr_reverse_test(
            rrule(YEARLY, count=3, bysecond=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrMonthly(self):
        self._rrulestr_reverse_test(
            rrule(MONTHLY, count=3, dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrMonthlyByMonth(self):
        self._rrulestr_reverse_test(
            rrule(MONTHLY, count=3, bymonth=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrMonthlyByMonthDay(self):
        self._rrulestr_reverse_test(
            rrule(
                MONTHLY, count=3, bymonthday=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrMonthlyByWeekDay(self):
        self._rrulestr_reverse_test(
            rrule(
                MONTHLY, count=3, byweekday=(TU, TH), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrMonthlyByHour(self):
        self._rrulestr_reverse_test(
            rrule(MONTHLY, count=3, byhour=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrMonthlyByMinute(self):
        self._rrulestr_reverse_test(
            rrule(
                MONTHLY, count=3, byminute=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrMonthlyBySecond(self):
        self._rrulestr_reverse_test(
            rrule(
                MONTHLY, count=3, bysecond=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrWeekly(self):
        self._rrulestr_reverse_test(
            rrule(WEEKLY, count=3, dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrWeeklyByMonth(self):
        self._rrulestr_reverse_test(
            rrule(WEEKLY, count=3, bymonth=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrWeeklyByMonthDay(self):
        self._rrulestr_reverse_test(
            rrule(
                WEEKLY, count=3, bymonthday=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrWeeklyByWeekDay(self):
        self._rrulestr_reverse_test(
            rrule(
                WEEKLY, count=3, byweekday=(TU, TH), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrWeeklyByHour(self):
        self._rrulestr_reverse_test(
            rrule(WEEKLY, count=3, byhour=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrWeeklyByMinute(self):
        self._rrulestr_reverse_test(
            rrule(WEEKLY, count=3, byminute=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrWeeklyBySecond(self):
        self._rrulestr_reverse_test(
            rrule(WEEKLY, count=3, bysecond=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrDailyInterval(self):
        self._rrulestr_reverse_test(
            rrule(DAILY, count=3, interval=2, dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrDailyByMonth(self):
        self._rrulestr_reverse_test(
            rrule(DAILY, count=3, bymonth=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrDailyByMonthDay(self):
        self._rrulestr_reverse_test(
            rrule(DAILY, count=3, bymonthday=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrDailyByWeekDay(self):
        self._rrulestr_reverse_test(
            rrule(
                DAILY, count=3, byweekday=(TU, TH), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrDailyByEaster(self):
        self._rrulestr_reverse_test(
            rrule(DAILY, count=3, byeaster=0, dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrDailyByHour(self):
        self._rrulestr_reverse_test(
            rrule(DAILY, count=3, byhour=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrDailyByMinute(self):
        self._rrulestr_reverse_test(
            rrule(DAILY, count=3, byminute=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrDailyBySecond(self):
        self._rrulestr_reverse_test(
            rrule(DAILY, count=3, bysecond=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrHourly(self):
        self._rrulestr_reverse_test(
            rrule(HOURLY, count=3, dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrHourlyByMonth(self):
        self._rrulestr_reverse_test(
            rrule(HOURLY, count=3, bymonth=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrHourlyByMonthDay(self):
        self._rrulestr_reverse_test(
            rrule(
                HOURLY, count=3, bymonthday=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrHourlyByWeekDay(self):
        self._rrulestr_reverse_test(
            rrule(
                HOURLY, count=3, byweekday=(TU, TH), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrHourlyByHour(self):
        self._rrulestr_reverse_test(
            rrule(HOURLY, count=3, byhour=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrHourlyByMinute(self):
        self._rrulestr_reverse_test(
            rrule(HOURLY, count=3, byminute=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrHourlyBySecond(self):
        self._rrulestr_reverse_test(
            rrule(HOURLY, count=3, bysecond=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrMinutely(self):
        self._rrulestr_reverse_test(
            rrule(MINUTELY, count=3, dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrMinutelyIntervalLarge(self):
        self._rrulestr_reverse_test(
            rrule(MINUTELY, count=3, interval=1501, dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrMinutelyByMonth(self):
        self._rrulestr_reverse_test(
            rrule(MINUTELY, count=3, bymonth=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrMinutelyByMonthDay(self):
        self._rrulestr_reverse_test(
            rrule(
                MINUTELY, count=3, bymonthday=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrMinutelyByWeekNo(self):
        self._rrulestr_reverse_test(
            rrule(MINUTELY, count=3, byweekno=20, dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrMinutelyByHour(self):
        self._rrulestr_reverse_test(
            rrule(MINUTELY, count=3, byhour=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrMinutelyByMinute(self):
        self._rrulestr_reverse_test(
            rrule(
                MINUTELY, count=3, byminute=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrMinutelyBySecond(self):
        self._rrulestr_reverse_test(
            rrule(
                MINUTELY, count=3, bysecond=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrSecondly(self):
        self._rrulestr_reverse_test(
            rrule(SECONDLY, count=3, dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrSecondlyIntervalLarge(self):
        self._rrulestr_reverse_test(
            rrule(SECONDLY, count=3, interval=90061, dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrSecondlyByMonth(self):
        self._rrulestr_reverse_test(
            rrule(SECONDLY, count=3, bymonth=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrSecondlyByMonthDay(self):
        self._rrulestr_reverse_test(
            rrule(
                SECONDLY, count=3, bymonthday=(1, 3), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrSecondlyByWeekNo(self):
        self._rrulestr_reverse_test(
            rrule(SECONDLY, count=3, byweekno=20, dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testToStrSecondlyByHour(self):
        self._rrulestr_reverse_test(
            rrule(SECONDLY, count=3, byhour=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0))
        )

    def testToStrSecondlyByMinute(self):
        self._rrulestr_reverse_test(
            rrule(
                SECONDLY, count=3, byminute=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
    ...
    def testToStrSecondlyBySecond(self):
        self._rrulestr_reverse_test(
            rrule(
                SECONDLY, count=3, bysecond=(6, 18), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
...
class RRuleSetTest(unittest.TestCase):
    def testSet(self):
        rrset = rruleset()
        rrset.rrule(
            rrule(YEARLY, count=2, byweekday=TU, dtstart=datetime(1997, 9, 2, 9, 0))
        )
        rrset.rrule(
            rrule(YEARLY, count=1, byweekday=TH, dtstart=datetime(1997, 9, 2, 9, 0))
        )
        self.assertEqual(
            list(rrset),
            [
    ...
    def testSetDate(self):
        rrset = rruleset()
        rrset.rrule(
            rrule(YEARLY, count=1, byweekday=TU, dtstart=datetime(1997, 9, 2, 9, 0))
        )
    ...
    def testSetExRule(self):
        ...
        rrset.rrule(
            rrule(
                YEARLY, count=6, byweekday=(TU, TH), dtstart=datetime(1997, 9, 2, 9, 0)
            )
        )
        rrset.exrule(
            rrule(YEARLY, count=3, byweekday=TH, dtstart=datetime(1997, 9, 2, 9, 0))
        )
        self.assertEqual(
            list(rrset),
            [
    ...
    def testSetExDateRevOrder(self):
        rrset = rruleset()
        rrset.rrule(
            rrule(MONTHLY, count=5, bymonthday=10, dtstart=datetime(2004, 1, 1, 9, 0))
        )
    ...
    def testSetRRuleCount(self):
        ...
        for cache in (True, False):
            ...
            rrset.rrule(
                rrule(YEARLY, count=2, byweekday=TH, dtstart=datetime(1983, 4, 1))
            )
            rrset.rrule(
                rrule(WEEKLY, count=4, byweekday=FR, dtstart=datetime(1991, 6, 3))
            )
    ...
    def testSetExRuleCount(self):
        ...
        for cache in (True, False):
            ...
            # This should invalidate the cache and force an update
            rrset.exrule(
                rrule(WEEKLY, count=2, interval=2, dtstart=datetime(1991, 6, 14))
            )
