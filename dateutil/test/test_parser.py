...
import pytest
from six import PY3, assertRaisesRegex
...
class ParserTest(unittest.TestCase):
    ...
    def testParseStr(self):
        self.assertEqual(parse(self.str_str), parse(self.uni_str))
    ...
    def testParseBytearray(self):
        # GH #417
        self.assertEqual(parse(bytearray(b"2014 January 19")), datetime(2014, 1, 19))

    def testParserParseStr(self):
        from dateutil.parser import parser

        self.assertEqual(parser().parse(self.str_str), parser().parse(self.uni_str))
    ...
    def testParseUnicodeWords(self):
        ...
        self.assertEqual(
            parse("10 Сентябрь 2015 10:20", parserinfo=rus_parserinfo()),
    ...
    def testParseWithNulls(self):
        ...
        self.assertEqual(parse(pstring), datetime(1924, 8, 29))
    ...
    def testDateCommandFormatWithLong(self):
        if not PY3:
            self.assertEqual(
                parse("Thu Sep 25 10:36:28 BRST 2003", tzinfos={"BRST": long(-10800)}),
                datetime(2003, 9, 25, 10, 36, 28, tzinfo=self.brsttz),
            )
    ...
    def testDateCommandFormatStrip1(self):
        self.assertEqual(
            parse("Thu Sep 25 10:36:28 2003"), datetime(2003, 9, 25, 10, 36, 28)
        )
    ...
    def testDateCommandFormatStrip6(self):
        self.assertEqual(
            parse("10:36:28", default=self.default), datetime(2003, 9, 25, 10, 36, 28)
        )

    def testDateCommandFormatStrip7(self):
        self.assertEqual(
            parse("10:36", default=self.default), datetime(2003, 9, 25, 10, 36)
        )
    ...
    def testISOFormatStrip2(self):
        self.assertEqual(
            parse("2003-09-25T10:49:41"), datetime(2003, 9, 25, 10, 49, 41)
        )
    ...
    def testPythonLoggerFormat(self):
        self.assertEqual(
            parse("2003-09-25 10:49:41,502"), datetime(2003, 9, 25, 10, 49, 41, 502000)
        )
    ...
    def testHourWithLettersStrip1(self):
        self.assertEqual(
            parse("10h36m28s", default=self.default), datetime(2003, 9, 25, 10, 36, 28)
        )

    def testHourWithLettersStrip2(self):
        self.assertEqual(
            parse("10h36m", default=self.default), datetime(2003, 9, 25, 10, 36)
        )
    ...
    def testHourWithLettersStrip4(self):
        self.assertEqual(
            parse("10 h 36", default=self.default), datetime(2003, 9, 25, 10, 36)
        )

    def testHourWithLetterStrip5(self):
        self.assertEqual(
            parse("10 h 36.5", default=self.default), datetime(2003, 9, 25, 10, 36, 30)
        )

    def testMinuteWithLettersSpaces1(self):
        self.assertEqual(
            parse("36 m 5", default=self.default), datetime(2003, 9, 25, 0, 36, 5)
        )

    def testMinuteWithLettersSpaces2(self):
        self.assertEqual(
            parse("36 m 5 s", default=self.default), datetime(2003, 9, 25, 0, 36, 5)
        )

    def testMinuteWithLettersSpaces3(self):
        self.assertEqual(
            parse("36 m 05", default=self.default), datetime(2003, 9, 25, 0, 36, 5)
        )

    def testMinuteWithLettersSpaces4(self):
        self.assertEqual(
            parse("36 m 05 s", default=self.default), datetime(2003, 9, 25, 0, 36, 5)
        )
    ...
    def testHourAmPm1(self):
        self.assertEqual(
            parse("10h am", default=self.default), datetime(2003, 9, 25, 10)
        )

    def testHourAmPm2(self):
        self.assertEqual(
            parse("10h pm", default=self.default), datetime(2003, 9, 25, 22)
        )
    ...
    def testHourAmPm5(self):
        self.assertEqual(
            parse("10:00 am", default=self.default), datetime(2003, 9, 25, 10)
        )

    def testHourAmPm6(self):
        self.assertEqual(
            parse("10:00 pm", default=self.default), datetime(2003, 9, 25, 22)
        )

    def testHourAmPm7(self):
        self.assertEqual(
            parse("10:00am", default=self.default), datetime(2003, 9, 25, 10)
        )

    def testHourAmPm8(self):
        self.assertEqual(
            parse("10:00pm", default=self.default), datetime(2003, 9, 25, 22)
        )

    def testHourAmPm9(self):
        self.assertEqual(
            parse("10:00a.m", default=self.default), datetime(2003, 9, 25, 10)
        )

    def testHourAmPm10(self):
        self.assertEqual(
            parse("10:00p.m", default=self.default), datetime(2003, 9, 25, 22)
        )
    ...
    def testLongWeekday(self):
        self.assertEqual(
            parse("Wednesday", default=self.default), datetime(2003, 10, 1)
        )
    ...
    def testZeroYear(self):
        self.assertEqual(
            parse("31-Dec-00", default=self.default), datetime(2000, 12, 31)
        )

    def testFuzzy(self):
        s = "Today is 25 of September of 2003, exactly " "at 10:49:41 with timezone -03:00."
        self.assertEqual(
            parse(s, fuzzy=True), datetime(2003, 9, 25, 10, 49, 41, tzinfo=self.brsttz)
        )
    ...
    def testExtraSpace(self):
        self.assertEqual(
            parse("  July   4 ,  1976   12:01:02   am  "), datetime(1976, 7, 4, 0, 1, 2)
        )
    ...
    def testRandomFormat3(self):
        self.assertEqual(
            parse("1996.July.10 AD 12:08 PM"), datetime(1996, 7, 10, 12, 8)
        )
    ...
    def testRandomFormat13(self):
        self.assertEqual(
            parse("0:01:02", default=self.default), datetime(2003, 9, 25, 0, 1, 2)
        )

    def testRandomFormat14(self):
        self.assertEqual(
            parse("12h 01m02s am", default=self.default), datetime(2003, 9, 25, 0, 1, 2)
        )

    def testRandomFormat15(self):
        self.assertEqual(
            parse("0:01:02 on July 4, 1976"), datetime(1976, 7, 4, 0, 1, 2)
        )
    ...
    def testRandomFormat17(self):
        self.assertEqual(
            parse("1976-07-04T00:01:02Z", ignoretz=True), datetime(1976, 7, 4, 0, 1, 2)
        )
    ...
    def testRandomFormat19(self):
        self.assertEqual(
            parse("Mon Jan  2 04:24:27 1995"), datetime(1995, 1, 2, 4, 24, 27)
        )
    ...
    def testRandomFormat22(self):
        self.assertEqual(
            parse("Jan 1 1999 11:23:34.578"), datetime(1999, 1, 1, 11, 23, 34, 578000)
        )
    ...
    def testRandomFormat25(self):
        self.assertEqual(
            parse("12:08 PM", default=self.default), datetime(2003, 9, 25, 12, 8)
        )
    ...
    def testRandomFormat30(self):
        self.assertEqual(
            parse("01h02m03", default=self.default), datetime(2003, 9, 25, 1, 2, 3)
        )

    def testRandomFormat31(self):
        self.assertEqual(
            parse("01h02", default=self.default), datetime(2003, 9, 25, 1, 2)
        )

    def testRandomFormat32(self):
        self.assertEqual(
            parse("01h02s", default=self.default), datetime(2003, 9, 25, 1, 0, 2)
        )

    def testRandomFormat33(self):
        self.assertEqual(
            parse("01m02", default=self.default), datetime(2003, 9, 25, 0, 1, 2)
        )

    def testRandomFormat34(self):
        self.assertEqual(
            parse("01m02h", default=self.default), datetime(2003, 9, 25, 2, 1)
        )
    ...
    def test_99_ad(self):
        self.assertEqual(parse("0099-01-01T00:00:00"), datetime(99, 1, 1, 0, 0))

    def test_31_ad(self):
        self.assertEqual(parse("0031-01-01T00:00:00"), datetime(31, 1, 1, 0, 0))
    ...
    def testUnspecifiedDayFallback(self):
        ...
        self.assertEqual(
            parse("April 2009", default=datetime(2010, 1, 31)), datetime(2009, 4, 30)
        )

    def testUnspecifiedDayFallbackFebNoLeapYear(self):
        self.assertEqual(
            parse("Feb 2007", default=datetime(2010, 1, 31)), datetime(2007, 2, 28)
        )

    def testUnspecifiedDayFallbackFebLeapYear(self):
        self.assertEqual(
            parse("Feb 2008", default=datetime(2010, 1, 31)), datetime(2008, 2, 29)
        )

    def testTzinfoDictionaryCouldReturnNone(self):
        self.assertEqual(
            parse("2017-02-03 12:40 BRST", tzinfos={"BRST": None}),
            datetime(2017, 2, 3, 12, 40),
        )

    def testTzinfosCallableCouldReturnNone(self):
        self.assertEqual(
            parse("2017-02-03 12:40 BRST", tzinfos=lambda *args: None),
            datetime(2017, 2, 3, 12, 40),
        )

    def testErrorType01(self):
        self.assertRaises(ValueError, parse, "shouldfail")
